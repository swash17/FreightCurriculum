...
## Supply Chain Management {Supply Chain-Seaportmng}
...
```
## The role of ports in the supply chain {Supply Chain-Seaportrole}
...
## Ports and Their Impact on the Global Supply Chain {Supply Chain-Seaport impact}
...
## Rail Ports {Supply Chain-Railport}
## Rail Transport{Supply Chain-RailTransport}
...
## Railroad Network {Supply Chain-Railroadnetwork}
...
## How can freight railroads be accessed? {Supply Chain-Railroad}
...
## What is a Rail-port? {Supply Chain-what is Railport}
...
```
## Types of Rail Terminals {Supply Chain-Railporttypes}
...
```
##The Global Supply Chain {Supply Chain-Railportglobal}
...
##The Role of Rail in the Supply Chain {Supply Chain-Railportsupplychain}
...
## Rail Service During Supply Chain Disruptions {Supply Chain-Railport service}
...
## The Economic Impact of Freight Railroads {Supply Chain-Railportimpact}
...
## First/ Last Mile {Supply Chain-First and Last Mile}
## What Is First/Last Mile? {Supply Chain-whatisFirst&LastMile}
What is First Mile?
...
knitr::include_graphics("./Images/Allan/First and Last Mile.jpg")
```
...
knitr::include_graphics("./Images/Allan/First and Last Mile Operation.jpg")
```
...
knitr::include_graphics("./Images/Allan/How Networks are Built.jpg")
```
...
knitr::include_graphics("./Images/Allan/Relation with Transportation.jpg")
```
...
knitr::include_graphics("./Images/Allan/How does it relate to Transportation.jpg")
```
...
knitr::include_graphics("./Images/Allan/Autonomous Delivery Robot.jpg")
```
## How does it relate to Transportation? 
...
knitr::include_graphics("./Images/Allan/Passenger transport.jpg")
```
## Challenges
...
knitr::include_graphics("./Images/Allan/Long Haul and Short Haul.jpg")
```
##Land Transportation
...
knitr::include_graphics("./Images/Allan/Long Haul.jpg")
```
Short Haul:
...
knitr::include_graphics("./Images/Allan/Short Haul.jpg")
```
...
knitr::include_graphics("./Images/Allan/Air Transportation Long Haul.jpg")
```
Ultra Long Haul: 
...
knitr::include_graphics("./Images/Allan/Ultra Long Haul.jpg")
```
...
knitr::include_graphics("./Images/Allan/Air Transportation Short Haul.jpg")
```
