# Regulatory Organizations{#safety}
...
```{r FigureFMCSA, echo=FALSE, fig.cap='Federal Motor Carrier Safety Administration', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/EnforcementAndSafetyOrganizations/Federal Motor Carrier Safety Administration.jpg")
```
...
knitr::include_graphics("./Images/EnforcementAndSafetyOrganizations/DOT.jpg")
```
...
knitr::include_graphics("./Images/EnforcementAndSafetyOrganizations/Purpose.jpg")
```
...
knitr::include_graphics("./Images/EnforcementAndSafetyOrganizations/Educational Awareness.jpg")
```

```{r Figure 10.5, echo=FALSE, fig.cap='Programs', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/EnforcementAndSafetyOrganizations/Programs.jpg")
```
...
knitr::include_graphics("./Images/EnforcementAndSafetyOrganizations/Educational Awareness-USDOT.jpg")
```

```{r Figure 10.7, echo=FALSE, fig.cap='National Consumer Complaint Database (NCCDB)', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/EnforcementAndSafetyOrganizations/National Consumer Complaint Database (NCCDB).jpg")
```
...
knitr::include_graphics("./Images/ResearchOrganizations/FLHSMV.jpg")
```
