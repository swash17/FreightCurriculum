...
```{r FreightByTonMile, echo=FALSE, fig.cap='Ton-Miles of Freight', fig.width=6, fig.align='center'}
...
```{r Figure 2.7, echo=FALSE, fig.cap='Weight and Value Freight Shipments by Domestic Mode- 2017', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Intro/Weight and Value Freight Shipments by Domestic Mode- 2017.jpg")
```



```{r Figure 2.8, echo=FALSE, fig.cap='Value of Freight Shipments by State- 2017', fig.width=4, fig.align='center'}
...
```{r Figure 2.9, echo=FALSE, fig.cap='Mode Share of Freight Ton-Miles by Distance Band-2007', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Intro/Mode Share of Freight Ton-Miles by Distance Band-2007.jpg")
```



```{r Figure 2.10, echo=FALSE, fig.cap='Data for Mode Share of Freight Ton-Miles by Distance Band- 2007', fig.width=4, fig.align='center'}
...
## Goods Volume/ Value Coming Into/ Out Various Sea Ports {#intro-Goods_Volume}
...
## Sea Port {#intro-Sea_Port_Function}
...
```{r Figure 2.11, echo=FALSE, fig.cap='Sea Port', fig.width=6, fig.align='center'}
knitr::include_graphics("./Images/Intro/Sea Port.jpg")
```
Source: https://www.porttechnology.org/news/what-are-sea-ports/#:~:text=Sea%20ports%20are%20maritime%20facilities,and%20discharge%20cargo%20and%20passengers.
...
1) The Nation’s ports handle the lion’s share of U.S. international trade and transportation.
...
```{r Figure 2.12, echo=FALSE, fig.cap='Monthly U.S. international freight value', fig.width=6, fig.align='center'}
...
```{r Figure 2.13, echo=FALSE, fig.cap='Operations of container seaport', fig.width=6, fig.align='center'}
...
```{r Figure 2.14, echo=FALSE, fig.cap='Scheme of a port terminal of containers showing the three main zones', fig.width=6, fig.align='center'}
...
1) Let’s assume a renowned Denim brand from the US wants to outsource its jeans consignment from China. Once the consignment is ready, the exporter will first select a particular shipping company whose container will come to its factory for cargo loading.
...
```{r Figure 2.15, echo=FALSE, fig.cap='Example of Goods movement from port of entry to customer', fig.width=6, fig.align='center'}
knitr::include_graphics("./Images/Intro/Example of Goods movement from port of entry to customer.jpg")
```


## Sea-port Logistic {#intro-port_Logistic}
...
```{r Figure 2.16, echo=FALSE, fig.cap='Sea-port logistics', fig.width=6, fig.align='center'}
knitr::include_graphics("./Images/Intro/Sea-port logistics.jpg")
```


```{r Figure 2.17, echo=FALSE, fig.cap='Warehousing services', fig.width=6, fig.align='center'}
