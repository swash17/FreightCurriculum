...
knitr::include_graphics("./Images/planning design/State DOTs.jpg")
```
...
knitr::include_graphics("./Images/planning design/planning.jpg")
```
...
knitr::include_graphics("./Images/planning design/planning process.jpg")
```
...
knitr::include_graphics("./Images/planning design/operation management.jpg")
```
...
knitr::include_graphics("./Images/planning design/vision.jpg")
```
...
knitr::include_graphics("./Images/planning design/Strategic Goals.jpg")
```
