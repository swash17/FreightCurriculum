...
knitr::include_graphics("./Images/jasmine/State DOTs.jpg")
```
...
knitr::include_graphics("./Images/jasmine/planning.jpg")
```
...
knitr::include_graphics("./Images/jasmine/planning process.jpg")
```
...
knitr::include_graphics("./Images/jasmine/operation management.jpg")
```
...
knitr::include_graphics("./Images/jayisha/vision.jpg")
```
...
knitr::include_graphics("./Images/jayisha/Strategic Goals.jpg")
```
