# Research organizations {#ResearchOrganizations}

::: {#Note .ThreshValue .message style="color: orange;"}
This chapter still needs a lot of work. It has Evangelos' and Lili's names in the topic assignment spreadsheet.
:::
...
knitr::include_graphics("./Images/ResearchOrganizations/Importance of Enforcement.jpg")
```
...
knitr::include_graphics("./Images/ResearchOrganizations/ATRI.jpg")
```

## ATRI Focus Areas {#organization-focusareas}


```{r Figure 12.3, echo=FALSE, fig.cap='Focus Areas', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/ResearchOrganizations/Focus Areas.jpg")
```
...
knitr::include_graphics("./Images/ResearchOrganizations/USDOT.jpg")
```
...
knitr::include_graphics("./Images/ResearchOrganizations/Team Responsibilities.jpg")
```

## USDOT Safety Overview{#organization-overview}

```{r Figure 12.7, echo=FALSE, fig.cap='Overview', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/ResearchOrganizations/Overview.jpg")
```
...
knitr::include_graphics("./Images/ResearchOrganizations/USDOT Safety Overview.jpg")
```
