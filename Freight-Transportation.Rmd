...
```{r Figure 3.1, echo=FALSE, fig.cap='Freight Transportation Services Index 2016–2021', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/jayisha/Freight Transportation Services Index 2016–2021.jpg")
```
## Freight Transportation and the Economy {#intro-Freight_Index}
...
```{r Figure 3.1, echo=FALSE, fig.cap='Freight by Mode 2018', fig.width=4, fig.align='center'}
...
```{r VehClassesImage, echo=FALSE, fig.cap='FHWA Vehicle Classifications', fig.width=6, fig.align='center'}
...
<!--chapter:end:03-loadingChars.Rmd-->
...
<!--chapter:end:04-driverIssues.Rmd-->
