...
knitr::include_graphics("./Images/Research organizations/Importance of Enforcement.jpg")
```
...
knitr::include_graphics("./Images/Research organizations/ATRI.jpg")
```
...
knitr::include_graphics("./Images/Research organizations/Focus Areas.jpg")
```
...
knitr::include_graphics("./Images/Research organizations/FLHSMV.jpg")
```
...
knitr::include_graphics("./Images/Research organizations/USDOT.jpg")
```
...
knitr::include_graphics("./Images/Research organizations/Team Responsibilities.jpg")
```

## USDOT Safety Overview{#organization-overview}

```{r Figure 12.7, echo=FALSE, fig.cap='Overview', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Research organizations/Overview.jpg")
```
...
knitr::include_graphics("./Images/Research organizations/USDOT Safety Overview.jpg")
```
