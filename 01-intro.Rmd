...
knitr::include_graphics("./Images/jayisha/Mode Share of Freight Ton-Miles by Distance Band-2007.jpg")
```
...
knitr::include_graphics("./Images/jayisha/Data for Mode Share of Freight Ton-Miles by Distance Band- 2007.jpg")
```
...
knitr::include_graphics("./Images/jayisha/Sea Port.jpg")
```
...
## The busiest container ports in the United States {#intro-busiest container_ports}
...
knitr::include_graphics("./Images/jayisha/Monthly U.S. international freight value.jpg")
```
...
knitr::include_graphics("./Images/jayisha/Operations of container seaport.jpg")
```
...
knitr::include_graphics("./Images/jayisha/Scheme of a port terminal of containers showing the three main zones.jpg")
```
...
knitr::include_graphics("./Images/jayisha/Example of Goods movement from port of entry to customer.jpg")
```
...
knitr::include_graphics("./Images/jayisha/Sea-port logistics.jpg")
```


```{r Figure 2.17, echo=FALSE, fig.cap='Warehousing services', fig.width=6, fig.align='center'}
knitr::include_graphics("./Images/jayisha/Warehousing services.jpg")
```
