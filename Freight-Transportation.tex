...
\hypersetup{
  pdftitle={Freight Transportation},
  pdfauthor={Scott S. Washburn, Evangelos Kaiser, Lili Du},
  hidelinks,
...
\title{Freight Transportation}
\author{Scott S. Washburn, Evangelos Kaiser, Lili Du}
\date{2021-06-09}
...
This material is intended for an introduction to freight transportation course.
...
\includegraphics{Images/PortOfMiami.bmp} \includegraphics{Images/PortOfMiami.bmp} \includegraphics{Images/PortOfMiami.bmp}
...
Table with tons of freight moved per year by mode

Reference Bureau of Transportation Statistics (BTS)
