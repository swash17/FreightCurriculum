...
knitr::include_graphics("./Images/Kaytlynn/Reefer Unit.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Types of Reefer Containers.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Reefer Container.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Industry Regulation.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Containers.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Container Size.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Container Markings.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/ISO Standard Container Markings.jpg")
```
## Types of Containers
...
knitr::include_graphics("./Images/Kaytlynn/Types of Containers.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Container Packing.jpg")
```
...
knitr::include_graphics("./Images/Kaytlynn/Bill of Lading.jpg")
```
