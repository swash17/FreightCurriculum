...
knitr::include_graphics("./Images/seaport operation/Reefer Unit.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Types of Reefer Containers.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Reefer Container.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Industry Regulation.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Containers.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Container Size.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Container Markings.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/ISO Standard Container Markings.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Types of Containers.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Container Packing.jpg")
```
...
knitr::include_graphics("./Images/seaport operation/Bill of Lading.jpg")
```
