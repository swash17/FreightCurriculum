...
knitr::include_graphics("./Images/Enforcement and Safety Organizations/Federal Motor Carrier Safety Administration.jpg")
```
...
knitr::include_graphics("./Images/Enforcement and Safety Organizations/DOT.jpg")
```
...
knitr::include_graphics("./Images/Enforcement and Safety Organizations/Purpose.jpg")
```
...
knitr::include_graphics("./Images/Enforcement and Safety Organizations/Educational Awareness.jpg")
```

```{r Figure 10.5, echo=FALSE, fig.cap='Programs', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Enforcement and Safety Organizations/Programs.jpg")
```
...
knitr::include_graphics("./Images/Enforcement and Safety Organizations/Educational Awareness-USDOT.jpg")
```

```{r Figure 10.7, echo=FALSE, fig.cap='National Consumer Complaint Database (NCCDB)', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Enforcement and Safety Organizations/National Consumer Complaint Database (NCCDB).jpg")
```
