...
## Private, such as Travel Centers of America/Petro {#parking-privateparking}
...
knitr::include_graphics("./Images/Parking/Parking.jpg")
```
...
knitr::include_graphics("./Images/Parking/Private Parking.jpg")
```
...
knitr::include_graphics("./Images/Parking/Private Parking-Convenience.jpg")
```
...
knitr::include_graphics("./Images/Parking/Private Parking-Security.jpg")
```
...
knitr::include_graphics("./Images/Parking/Private Parking-Cost Effectiveness.jpg")
```
5. Technology:
Online booking
...
knitr::include_graphics("./Images/Parking/Private Parking-Technology.jpg")
```
...
knitr::include_graphics("./Images/Parking/Private Parking location.jpg")
```
...
knitr::include_graphics("./Images/Parking/Private Parking Companies.jpg")
```
...
knitr::include_graphics("./Images/Parking/Travel Centers of America.jpg")
```


## Parking Availability Technology/Information Systems

Many states are utilizing technology to provide information about truck parking space availability at public rest areas. These technologies include in-ground sensors in individual parking spaces, video image processing, and entry/exit vehicle classification sensors. The information is then conveyed to truck drivers through roadside signs (Figure \@ref(fig:ParkingSpacesSign)), websites (Figure \@ref(fig:ParkingSpacesWebsite)), and/or phone apps (Figure \@ref(fig:ParkingSpacesPhoneApp)).

```{r ParkingSpacesSign, echo=FALSE, fig.cap='Travel Centers of America', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Parking/ParkingSpacesSign.jpg")
```

```{r ParkingSpacesWebsite, echo=FALSE, fig.cap='Travel Centers of America', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Parking/ParkingSpacesWebsite.png")
```

```{r ParkingSpacesPhoneApp, echo=FALSE, fig.cap='Travel Centers of America', fig.width=4, fig.align='center'}
knitr::include_graphics("./Images/Parking/ParkingSpacesPhoneApp.png")
```
